...
urlpatterns = [
    ...
    path('<str:pk>/inhabilitar/', PlotViewSet.as_view({'post': 'inhabilitar'}), name='inhabilitar-predio'),
    path('<str:pk>/habilitar/', PlotViewSet.as_view({'post': 'habilitar'}), name='habilitar-predio'),
]