    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flow_inconsistencies', to='plots_lots.plot', verbose_name='Predio')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flow_measurements_lote', to='plots_lots.lot', verbose_name='Lote')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flow_rate', models.FloatField(verbose_name='Caudal (m³/s)')),
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='Fecha y Hora')),
                ('plot', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='flow_measurement_predio', to='plots_lots.plot', verbose_name='Predio')),
            ],
            options={
