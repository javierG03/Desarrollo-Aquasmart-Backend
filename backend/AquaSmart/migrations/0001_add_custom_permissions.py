# Generated by Django 5.1.6 on 2025-03-18 21:25
...
def crear_permisos(apps, schema_editor):
    ...
    content_type, created = ContentType.objects.get_or_create(model="", app_label="AquaSmart")
    ...
    permisos = [
        ...
        ("solicitar_limitar_caudal_predio", "Permite solicitar la limitación de caudal para un predio"),
