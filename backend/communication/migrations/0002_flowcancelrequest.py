    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cancel_type', models.CharField(choices=[('temporal', 'Temporal'), ('definitiva', 'Definitiva')], help_text='Indica si la cancelación es temporal o definitiva', max_length=10, verbose_name='Tipo de cancelación')),
                ('observations', models.CharField(help_text='Motivo o detalles de la solicitud de cancelación (5 a 200 caracteres)', max_length=200, verbose_name='Observaciones')),
