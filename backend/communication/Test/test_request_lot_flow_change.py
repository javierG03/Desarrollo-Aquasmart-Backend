...
@pytest.mark.django_db
def flow_change_request_validation(api_client, normal_user, login_and_validate_otp, user_plot, user_lot, iot_device, device_type):
    """
    ✅ Verifica que un usuario autenticado pueda solicitar un cambio de caudal
    para un dispositivo IoT asociado a su predio.
    """
    ...
    assert iot_device.id_plot == user_plot, "❌ El dispositivo no está vinculado correctamente al predio"
